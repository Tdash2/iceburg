...
$PARAMS = [
    ...
    "eParamID_Vid1YUVProcAmpGain_SDI1" => ["type" => "slider", "group" => 1, "subgroup" => 2],
    "eParamID_Vid1YUVProcAmpBlack_SDI1" => ["type" => "slider", "group" => 1, "subgroup" => 2],
    "eParamID_Vid1YUVProcAmpHue_SDI1" => ["type" => "slider", "group" => 1, "subgroup" => 2],
    "eParamID_Vid1YUVProcAmpSat_SDI1" => ["type" => "slider", "group" => 1, "subgroup" => 2],
    

    "eParamID_Vid1RGBProcAmpGainRed_SDI1" => ["type" => "slider", "group" => 1, "subgroup" => 3],
    "eParamID_Vid1RGBProcAmpBlackRed_SDI1" => ["type" => "slider", "group" => 1, "subgroup" => 3],
    "eParamID_Vid1RGBProcAmpGammaRed_SDI1" => ["type" => "slider", "group" => 1, "subgroup" => 3],

    "eParamID_Vid1RGBProcAmpGainGreen_SDI1" => ["type" => "slider", "group" => 1, "subgroup" => 4],
    "eParamID_Vid1RGBProcAmpBlackGreen_SDI1" => ["type" => "slider", "group" => 1, "subgroup" => 4],
    "eParamID_Vid1RGBProcAmpGammaGreen_SDI1" => ["type" => "slider", "group" => 1, "subgroup" => 4],

    "eParamID_Vid1RGBProcAmpGainBlue_SDI1" => ["type" => "slider", "group" => 1, "subgroup" => 5],
    "eParamID_Vid1RGBProcAmpBlackBlue_SDI1" => ["type" => "slider", "group" => 1, "subgroup" => 5],
    "eParamID_Vid1RGBProcAmpGammaBlue_SDI1" => ["type" => "slider", "group" => 1, "subgroup" => 5],
    
    
    
    "eParamID_Vid2VideoInput" => ["type" => "dropdown", "group" => 2, "subgroup" => 1],
    "eParamID_Vid2OutputFormat_5923" => ["type" => "dropdown", "group" => 2, "subgroup" => 1],
    "eParamID_Vid2YUVProcAmpEnable_SDI1" => ["type" => "dropdown", "group" => 2, "subgroup" => 1],
    "eParamID_Vid2RGBProcAmpEnable_SDI1" => ["type" => "dropdown", "group" => 2, "subgroup" => 1],
    
    
    "eParamID_Vid2YUVProcAmpGain_SDI1" => ["type" => "slider", "group" => 2, "subgroup" => 2],
    "eParamID_Vid2YUVProcAmpBlack_SDI1" => ["type" => "slider", "group" => 2, "subgroup" => 2],
    "eParamID_Vid2YUVProcAmpHue_SDI1" => ["type" => "slider", "group" => 2, "subgroup" => 2],
    "eParamID_Vid2YUVProcAmpSat_SDI1" => ["type" => "slider", "group" => 2, "subgroup" => 2],
    

    "eParamID_Vid2RGBProcAmpGainRed_SDI1" => ["type" => "slider", "group" => 2, "subgroup" => 3],
    "eParamID_Vid2RGBProcAmpBlackRed_SDI1" => ["type" => "slider", "group" => 2, "subgroup" => 3],
    "eParamID_Vid2RGBProcAmpGammaRed_SDI1" => ["type" => "slider", "group" => 2, "subgroup" => 3],

    "eParamID_Vid2RGBProcAmpGainGreen_SDI1" => ["type" => "slider", "group" => 2, "subgroup" => 4],
    "eParamID_Vid2RGBProcAmpBlackGreen_SDI1" => ["type" => "slider", "group" => 2, "subgroup" => 4],
    "eParamID_Vid2RGBProcAmpGammaGreen_SDI1" => ["type" => "slider", "group" => 2, "subgroup" => 4],

    "eParamID_Vid2RGBProcAmpGainBlue_SDI1" => ["type" => "slider", "group" => 2, "subgroup" => 5],
    "eParamID_Vid2RGBProcAmpBlackBlue_SDI1" => ["type" => "slider", "group" => 2, "subgroup" => 5],
    "eParamID_Vid2RGBProcAmpGammaBlue_SDI1" => ["type" => "slider", "group" => 2, "subgroup" => 5],
